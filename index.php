    ...
    $faq = [
        ...
        [
            ...
            "answers" => "<p>Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:</p>
                        ...
                        <p>a. Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.</p>
                        <p>b. Google LLC, con sede negli Stati Uniti, per il resto del mondo.</p>
...
<body>
    <header>
        <div class="header-top">
            ...
            <div class="user">
                <a href="#" class="app"><i class="fas fa-th"></i></a>
